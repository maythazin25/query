...
--
-- Host: localhost
-- Generation Time: Oct 15, 2020 at 10:23 AM
...
CREATE TABLE `staffs` (
  `id` int(11) NOT NULL,
  `idno` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(5, '123456AB5', 'Kay Thwe', 'U Wanna Htun', 400000, '2014-06-11', 4),
(6, '123456AB6', 'San Myint Aung', 'U Kyaw Min', 400000, '2014-06-11', 5),
(7, '123456AB7', 'Phyo Wai Aung', 'U Myint Aung', 150000, '2014-01-20', 6),
